    ...
    >
      ...
      >
        ...
        <p className="text-gray-400 mt-6 text-lg font-semibold max-w-2xl mx-auto">
          A collection of my work experience and professional journey.
        </p>
      </motion.div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {experience.skills.map((skill, idx) => (
                      <motion.span
                        ...
                        className="bg-[#8245ec]/20 text-[#c084fc] px-3 py-1 text-xs 3xl:text-sm rounded-lg border border-[#8245ec]/40"
                      >
                        {skill}
                      </motion.span>
                    ))}
